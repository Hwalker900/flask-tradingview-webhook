from flask import Flask, request
   ...
   def format_message(pair, signal, entry, timestamp):
       ...
       try:
           ...
           # Construct message with static text
           message = f"""
🌟 *New Signal Alert\!*  
...
"""
           # Escape the entire message to handle static text (e.g., '!')
           escaped_message = escape_markdown_v2(message)
           print("Message constructed successfully")
           return escaped_message, confidence
       except Exception as e:
...
"""
   ...
   def send_daily_summary():
       ...
       send_telegram_message(escaped_summary)
       daily_signals.clear()
